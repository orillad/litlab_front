<template>
    <header class='flex  py-4 px-4 sm:px-10 bg-primary min-h-[80px] tracking-wide relative z-50'>
        <div class='flex flex-wrap items-center gap-5 w-full'>
            <a href="/"><img src="~/assets/images/logo.png" alt="logo" class='w-40 max-lg:mr-5' />
            </a>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    ...
                    <li class='max-lg:border-b max-lg:py-3 px-3'>
                            <LangSwitcher class="hover:text-secondary text-white font-light block text-[15px]"/>
                    </li>
                    ...
                    <li class='max-lg:border-b max-lg:py-3 px-3'>
                        <a href='/'
                            class='hover:text-secondary text-white font-light block text-[15px] '>{{ $t('header.home') }}</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                            class='hover:text-secondary text-white font-light block text-[15px]'>{{ $t('header.products') }}</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                            class='hover:text-secondary text-white font-light block text-[15px]'>{{ $t('header.us') }}</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'>
                            <img src="~/assets/images/carrito.svg" alt="logo">
                        </a>
                    </li>
                </ul>
            </div>
